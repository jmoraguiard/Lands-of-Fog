...
{ 
	...
	{    
		...
		string start = Time.time +";System;start;0;0";

		byte[] info = new UTF8Encoding(true).GetBytes(start+"\n");
		fileStream.Write(info, 0, info.Length);

		GameObject p1 = GameObject.Find ("Player1");
		string player1Position = Time.time + ";Player1;explorer;" + p1.transform.position.x + ";" + p1.transform.position.z;
		byte[] infoP1 = new UTF8Encoding(true).GetBytes(player1Position+"\n");
		fileStream.Write(infoP1, 0, infoP1.Length);
		
		GameObject p2 = GameObject.Find ("Player2");
		string player2Position = Time.time + ";Player2;explorer;" + p2.transform.position.x + ";" + p2.transform.position.z;
	...
	{
		GameObject p1 = GameObject.Find ("Player1");
		string player1Position = Time.time + ";Player1;pos;" + p1.transform.position.x + ";" + p1.transform.position.z;
		byte[] infoP1 = new UTF8Encoding(true).GetBytes(player1Position+"\n");
		fileStream.Write(infoP1, 0, infoP1.Length);

		GameObject p2 = GameObject.Find ("Player2");
		string player2Position = Time.time + ";Player2;pos;" + p2.transform.position.x + ";" + p2.transform.position.z;
		byte[] infoP2 = new UTF8Encoding(true).GetBytes(player2Position+"\n");
		fileStream.Write(infoP2, 0, infoP2.Length);
	}
	...
	public void insectCreated (Message_transform m)
	{
		...
		{
			GameObject p1 = GameObject.Find ("Player1");
			string player1Position = Time.time + ";Player1;hunted_insect;" + p1.transform.position.x + ";" + p1.transform.position.z;
			byte[] infoP1 = new UTF8Encoding(true).GetBytes(player1Position+"\n");
			fileStream.Write(infoP1, 0, infoP1.Length);

			if(player1State == PlayerState.Explorer)
			{
				string player1S = Time.time + ";Player1;hunter;" + p1.transform.position.x + ";" + p1.transform.position.z;
		...
		{
			GameObject p2 = GameObject.Find ("Player2");
			string player2Position = Time.time + ";Player2;hunted_insect;" + p2.transform.position.x + ";" + p2.transform.position.z;
			byte[] infoP2 = new UTF8Encoding(true).GetBytes(player2Position+"\n");
			fileStream.Write(infoP2, 0, infoP2.Length);

			if(player2State == PlayerState.Explorer)
			{
				string player2S = Time.time + ";Player2;hunter;" + p2.transform.position.x + ";" + p2.transform.position.z;
	...
	public void creatureGoingToBeCreated (Message m)
	{
		if ( m.MessageValue == "user1_swarm" )
		{
			...
			{
				string player1S = Time.time + ";Player1;character_creator;" + p1.transform.position.x + ";" + p1.transform.position.z;
				byte[] infoP1S = new UTF8Encoding(true).GetBytes(player1S+"\n");
				fileStream.Write(infoP1S, 0, infoP1S.Length);
		...
		if ( m.MessageValue == "user2_swarm" )
		{
			...
			{
				string player2S = Time.time + ";Player2;character_creator;" + p2.transform.position.x + ";" + p2.transform.position.z;
				byte[] infoP2S = new UTF8Encoding(true).GetBytes(player2S+"\n");
				fileStream.Write(infoP2S, 0, infoP2S.Length);
	...
	public void creatureCreated (Message m)
	{
		...
		{
			GameObject p1 = GameObject.Find ("Player1");
			string player1Position = Time.time + ";Player1;creature_created;" + p1.transform.position.x + ";" + p1.transform.position.z;
			byte[] infoP1 = new UTF8Encoding(true).GetBytes(player1Position+"\n");
			fileStream.Write(infoP1, 0, infoP1.Length);

			if(player1State == PlayerState.Character_Creator)
			{
				string player1S = Time.time + ";Player1;character_keeper;" + p1.transform.position.x + ";" + p1.transform.position.z;
				byte[] infoP1S = new UTF8Encoding(true).GetBytes(player1S+"\n");
				fileStream.Write(infoP1S, 0, infoP1S.Length);
		...
		{
			GameObject p2 = GameObject.Find ("Player2");
			string player2Position = Time.time + ";Player2;creature_created;" + p2.transform.position.x + ";" + p2.transform.position.z;
			byte[] infoP2 = new UTF8Encoding(true).GetBytes(player2Position+"\n");
			fileStream.Write(infoP2, 0, infoP2.Length);

			if(player2State == PlayerState.Character_Creator)
			{
				string player2S = Time.time + ";Player2;character_keeper;" + p2.transform.position.x + ";" + p2.transform.position.z;
				byte[] infoP2S = new UTF8Encoding(true).GetBytes(player2S+"\n");
				fileStream.Write(infoP2S, 0, infoP2S.Length);
	...
	public void creatureTextureChanged (Message m)
	{
		...
		{
			GameObject p1 = GameObject.Find ("Player1");
			string player1Position = Time.time + ";Player1;creature_changed;" + p1.transform.position.x + ";" + p1.transform.position.z;
			byte[] infoP1 = new UTF8Encoding(true).GetBytes(player1Position+"\n");
			fileStream.Write(infoP1, 0, infoP1.Length);
		}
		...
		{
			GameObject p2 = GameObject.Find ("Player2");
			string player2Position = Time.time + ";Player2;creature_changed;" + p2.transform.position.x + ";" + p2.transform.position.z;
			byte[] infoP2 = new UTF8Encoding(true).GetBytes(player2Position+"\n");
			fileStream.Write(infoP2, 0, infoP2.Length);
		}
	}
	...
	public void creaturePointsObject (Message m)
	{
		if ( m.MessageSource.tag == "creature1" )
		{
			...
			string player1Position = Time.time + ";Creature1;point_at;" + c1.transform.position.x + ";" + c1.transform.position.z;
		...
		if ( m.MessageSource.tag == "creature2" )
		{
			...
			string player1Position = Time.time + ";Creature2;point_at;" + c2.transform.position.x + ";" + c2.transform.position.z;
	...
	public void creatureLooksUp (Message m)
	{
		...
		{
			GameObject c1 = GameObject.FindGameObjectWithTag ("creature1");
			string player1Position = Time.time + ";Creature1;look_up;" + c1.transform.position.x + ";" + c1.transform.position.z;
			byte[] infoC1 = new UTF8Encoding(true).GetBytes(player1Position+"\n");
			fileStream.Write(infoC1, 0, infoC1.Length);
		}
		...
		{
			GameObject c2 = GameObject.FindGameObjectWithTag ("creature2");
			string player1Position = Time.time + ";Creature2;look_up;" + c2.transform.position.x + ";" + c2.transform.position.z;
			byte[] infoC2 = new UTF8Encoding(true).GetBytes(player1Position+"\n");
			fileStream.Write(infoC2, 0, infoC2.Length);
		}
	}
	...
	public void creatureGreeting (Message m)
	{
		...
		{
			GameObject c1 = GameObject.FindGameObjectWithTag ("creature1");
			string player1Position = Time.time + ";Creature1;greeting;" + c1.transform.position.x + ";" + c1.transform.position.z;
			byte[] infoC1 = new UTF8Encoding(true).GetBytes(player1Position+"\n");
			fileStream.Write(infoC1, 0, infoC1.Length);
		}
		...
		{
			GameObject c2 = GameObject.FindGameObjectWithTag ("creature2");
			string player1Position = Time.time + ";Creature2;greeting;" + c2.transform.position.x + ";" + c2.transform.position.z;
			byte[] infoC2 = new UTF8Encoding(true).GetBytes(player1Position+"\n");
			fileStream.Write(infoC2, 0, infoC2.Length);
		}
	}
	...
	public void creatureShared (Message m)
	{
		...
		{
			GameObject p1 = GameObject.Find ("Player1");
			string player1Position = Time.time + ";Player1;share_creature;" + p1.transform.position.x + ";" + p1.transform.position.z;
			byte[] infoP1 = new UTF8Encoding(true).GetBytes(player1Position+"\n");
			fileStream.Write(infoP1, 0, infoP1.Length);
		}
		...
		{
			GameObject p2 = GameObject.Find ("Player2");
			string player2Position = Time.time + ";Player2;share_creature;" + p2.transform.position.x + ";" + p2.transform.position.z;
			byte[] infoP2 = new UTF8Encoding(true).GetBytes(player2Position+"\n");
			fileStream.Write(infoP2, 0, infoP2.Length);
		}
	}
	...
	{
		string player1Position = Time.time + ";System;creature_merge;0;0";
		byte[] infoP1 = new UTF8Encoding(true).GetBytes(player1Position+"\n");
		fileStream.Write(infoP1, 0, infoP1.Length);
	}
	...
	public void manipulateProp (Message m)
	{
		...
		string player1Position = Time.time + ";" + m.MessageSource.tag + ";manipulate_prop;" + propPos.x + ";" + propPos.z;
		byte[] infoP1 = new UTF8Encoding(true).GetBytes(player1Position+"\n");
		fileStream.Write(infoP1, 0, infoP1.Length);
	}
	...
	{
		string start = Time.time +";System;end;0;0";
	...
	public void keyPressed(Message m) 
	{
		...
		if (m.MessageValue == "1") {
			message = Time.time + ";System;creature_changed_player1;0;0";
		}
		if (m.MessageValue == "2") {
			message = Time.time + ";System;creature_changed_player2;0;0";
		}
		if (m.MessageValue == "3") {
			message = Time.time + ";System;creature_created_player1;0;0";
		}
		if (m.MessageValue == "4") {
			message = Time.time + ";System;creature_created_player2;0;0";
		}
